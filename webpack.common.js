...
module.exports = {
  ...
  entry: {
    ...
    content_script: './src/whatbots/content_script.js',
    features_script: './src/popup/features.js',
    background:'./src/background/background.js'
    // waitForKeyElements:'./src/writebot/waitForKeyElements.js'
  },
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: path.join(__dirname, "src", "popup", "features.html"),
      filename: "features.html",
      chunks: ["features_script"] // This is script from entry point
    }),
